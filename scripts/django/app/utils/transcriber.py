...
def transcribe_gcs(mp4_file):
    ...
    if audio_file_path:
        bucket_name = 'meeting-recordings-ph1' # Your gcloud bucket name
        print(mp4_file)
        audio_file_name = audio_file_path + '.ogg'
        audio_file_name = os.path.basename(audio_file_name)
        ...
        audio = speech.RecognitionAudio(
            uri="gs://" + bucket_name + "/" + os.path.basename(audio_file_name))
